...
$LogDir = ".roadmap-runner-logs"   # dot-prefixed and distinctive so project scripts (npm test, build, clean) don't collide with it
...
"@
    ...
    # Recreate the folder every time: something in the project's own test/build
    # step may have deleted it since the last iteration (e.g. a "clean" script).
    New-Item -ItemType Directory -Force -Path $LogDir | Out-Null
