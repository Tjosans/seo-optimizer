...
export const TRIAGE: Readonly<Record<string, TriageEntry>> = {
  ...
  '2.11': ['automated', 'code', ['product-schema', 'merchant-feed-parity', 'review-integrity']],
  ...
  '3.10': ['automated', 'content', ['cannibalization']],
  ...
  '4.2': ['automated', 'config', ['indexability-matrix-reconciliation']],
  '4.3': ['assisted', 'code', ['mobile-journey-qa']],
  '4.4': ['assisted', 'code', ['axe-accessibility', 'manual-a11y-evaluation']],
  '4.5': ['automated', 'code', ['template-lab-perf']],
  '4.6': ['automated', 'code', ['schema-validation-parity']],
  ...
  '5.5': ['automated', 'config', ['availability-canary', 'indexability-canary']],
  ...
  '6.3': ['automated', 'config', ['reporting-anomaly-thresholds']],
  ...
  '6.8': ['automated', 'config', ['backlink-monitor']],
  ...
  '7.10': ['automated', 'config', ['security-dependency-maintenance']],
};
